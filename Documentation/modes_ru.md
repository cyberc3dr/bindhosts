...
- Требуется модификация исходного кода: [пример](https://github.com/tiann/KernelSU/commit/2b2b0733d7c57324b742c017c302fc2c411fe0eb)
...
- **ВНИМАНИЕ**: Конфликтует с SuSFS. Вам это не нужно, если вы можете реализовать SuSFS.
- Совместим с AdAway
